...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "drakonis~kr9BTaQA#piO2NRyiQh1jSgHv0vAQvsdxGZzPBULkTka8yv2H7-E",
    // add your Session Id make sure it starts with suho~

    PREFIX: process.env.PREFIX || ".",
    // add your prefix for bot

    BOT_NAME: process.env.BOT_NAME || "Hmanss",
...
> ɢɪᴛʜᴜʙ : github.com/NaCkS-ai/SungSu-ho-MD`,
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "263776369078",
    // add your bot owner number

    OWNER_NAME: process.env.OWNER_NAME || "Hman",
    // add bot owner name
